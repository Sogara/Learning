...
public class CalculatorTest {
    ...
    public static void main(String[] args) {
        ...
        cycle:while (true){ // запуск бесконечного цикла, пока не нажата цифра (5 - Выход)
        ...
        switch (action) { // вызывает и выводит в консоль выбранное действие: (add,subs,multi,div)
            ...
            case 1:
                System.out.println(String.format("%.4f", calculator.add()));
                break;
            case 2:
                System.out.println(String.format("%.4f", calculator.subs()));
                break;
            case 3:
                System.out.println(String.format("%.4f", calculator.multi()));
                break;
            case 4:
                System.out.println(String.format("%.4f", calculator.div()));
                break;
            case 0:
                break ;
            case 5: break cycle; // условия выхода из цыкла (нажатия цифры 5)
            default:
                System.out.println("Вы выбрали неверный пункт."); // вызывается, если введеное значение не соответсвует условию swith
